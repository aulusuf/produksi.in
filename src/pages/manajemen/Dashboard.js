      ...
      >
        ...
        <Row style={{marginTop:'2%'}}>
          <Col sm={4}>
            ...
            <Col>
              <div className="d-flex justify-content-center">
                <Button onClick={()=>setLgShowProfilEdit(true)} as="input" type="submit" value="Edit" className="button-edit-produk" style={{paddingLeft:'20px', paddingRight:'20px'}}/>
              </div>
            </Col>
          </Row>
        </Modal.Body>
        ...
        <Col>
          <div class="shadow-sm p-3 mt-3 bg-body rounded">
            ...
            <h3>Statistik</h3>
              ...
              <Row  style={{paddingLeft:'20px', marginTop:'32px'}}>
                <Col>
                  <Row>
                    <Col className="d-flex justify-content-center">
